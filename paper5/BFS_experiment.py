...
TRANSFERS_PRODUCE_CONFIG_s = [
    [[0.05, 0.05, math.radians(1.2)], [3, 3, 10]],  # 0.3m
    [[0.1, 0.1, math.radians(1.2)], [3, 3, 10]],  # 0.6m
    [[0.1, 0.1, math.radians(1.2)], [5, 5, 10]],  # 1m
    [[0.1, 0.1, math.radians(1.2)], [10, 10, 10]],  # 2m
    [[0.1, 0.1, math.radians(1.2)], [15, 15, 10]],  # 3
    [[0.1, 0.1, math.radians(1.2)], [20, 20, 10]],  # 4
    [[0.125, 0.125, math.radians(1.2)], [20, 20, 10]],  # 5
    [[0.15, 0.15, math.radians(1.2)], [20, 20, 10]],  # 6
    [[0.175, 0.175, math.radians(1.2)], [20, 20, 10]],  # 7
    [[0.2, 0.2, math.radians(1.2)], [20, 20, 10]]  # 8
]
...
def main():
    ...
    for TRANSFERS_PRODUCE_CONFIG in TRANSFERS_PRODUCE_CONFIG_s:
        print(TRANSFERS_PRODUCE_CONFIG)
