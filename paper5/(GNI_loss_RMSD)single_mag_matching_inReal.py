...
def main():
    ...
    np.savetxt("../paper5/results/badLoss_and_Winerror(InReal_InfCenter).csv", np.array(bad_loss_percent_and_dis), delimiter=',')
    print("save ../paper5/results/badLoss_and_Winerror(InReal_InfCenter).csv")
