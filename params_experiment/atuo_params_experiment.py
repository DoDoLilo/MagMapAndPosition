...
if __name__ == '__main__':
    ...
    parser.add_argument("params_factory", type=str)
    ...
    #   TODO 注意计算的 滑动距离(SLIDE_STEP * SLIDE_BLOCK_SIZE)要 < 滑动窗口大小！需要检查参数合法性的
    all_comb_dict_list = []
    ...
    with open(result_csv_file, "w", newline='') as csvfile:
        ...
        for params_dict in all_comb_dict_list:
            ...
            for PATH_PDR_RAW in PATH_PDR_RAW_list:
                # TODO 扔到mag_position_with_ilocator_for_exeriment里面去跑
                cur_result_list = mpp.mag_position_with_ilcator(
                    ...
                    TRANSFERS_PRODUCE_CONFIG=[
                        ...
                        ,
                        [params_dict['TRANSFERS_PRODUCE_CONFIG[1][0]'],
                         params_dict['TRANSFERS_PRODUCE_CONFIG[1][1]'],
                         params_dict['TRANSFERS_PRODUCE_CONFIG[1][2]']]
                    ],
                ...
                # TODO 将mag_position_with_ilocator_for_exeriment返回的结果和参数一起存一行excel
